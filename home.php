  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link text-light" href="register.php">Voucer</a>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Produk mingguan</a></li>
            <li><a class="dropdown-item" href="#">Produk bulanan</a></li>
      ...
      <form class="d-flex" role="search">
        ...
        <button class="btn  btn-dark btn-outline-primary" type="submit">Cari</button>
      </form>
    </div>
  </div>
</nav>
