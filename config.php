<?php
	...
	if($conn->connect_error){
		...
		$stmt = $conn->prepare("insert into register(username, email, password, nik, nm_member, nohp, kota, provinsi, wn) values('$username', '$email', '$password', '$nik', '$nm_member', '$nohp', '$kota', '$provinsi', '$wn')");
